rootProject.name = "cashflow-management-app"
...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            version("androidGradlePlugin", "7.3.0")
            version("junit", "5.9.2")
            ...
            version("slidinguppanel", "3.4.0")
            version("glide", "4.12.0")
            version("circleimage", "3.1.0")
            version("progressview", "3.0.0")
            ...
            library("coreTesting", "androidx.arch.core", "core-testing").versionRef("coreTesting")
            library("slidinguppanel", "com.sothree.slidinguppanel", "library").versionRef("slidinguppanel")
            library("glide", "com.github.bumptech.glide", "glide").versionRef("glide")
            library("circleimage", "de.hdodenhof", "circleimageview").versionRef("circleimage")
            library("progressview", "com.github.shts", "StoriesProgressView").versionRef("progressview")
